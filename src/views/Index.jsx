    ...
    <>
      ...
      <footer className="p-4 mt-4 text-center border-t border-gray-300">
        <div className="flex justify-center items-center gap-4 mb-2">
          ...
          {swStatus === 'active' && (
            <span className="text-xs text-green-600 flex items-center gap-1" title="Service Worker active - offline support enabled" aria-label="Offline support is active">
